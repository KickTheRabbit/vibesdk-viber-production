...
`),
                ...
                // Determine the correct action name based on config
                const isFileRegeneration = this.modelConfigOverride === AGENT_CONFIG.fileRegeneration;

                if (isFileRegeneration) {
                    console.log("[TRACKING] 🎯 fileRegeneration - START");
                } else {
                    console.log("[TRACKING] 🎯 realtimeCodeFixer - START");
                }
